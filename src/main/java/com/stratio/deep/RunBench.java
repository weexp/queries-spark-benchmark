...
public class RunBench {
    ...
    public static void main(String[] args) throws IOException, SigarException {
         ...
         * //****METRICAS
         * 
         * System.out.println ("Metricas del Main "); ReturnValue check_disk_all
         * = jnrpeClient.sendCommand("check_disk_all"); //"check_diks_all" -->
         * operaciones del agent.ini (/home/su/agentServer-0.1.0-alpha/conf)
         * Metric metric =
         * MetricParser.generateResult(check_disk_all.getMessage(),
         * check_disk_all.getStatus().getSeverity()); List<MetricValue> list =
         * metric.getMetricValues();//Sacar la operacion que interese
         * 
        ...
        deepContext.stop();
        /**************************************************************************
         * //calcular maximo Bench benchMax = new Bench(); String.format("%.2f",
         * benchMax.max(data, runs));
         * 
         * 
         * //calcular min Bench benchMin = new Bench(); String.format("%.2f",
         * benchMin.min(data, runs));
         * 
         * 
         * //calcular media Bench benchAvg= new Bench();
         * String.format("%.2f",benchAvg.media(data,runs));
         ***************************************************************************/
        /*
         * //Informacion del SO
         * 
         * InfoSO infoso = new InfoSO(); infoso.imprimirInfo();
         * infoso.imprimirUptime();
         * 
         * //Informacion CPU InfoCpu infocpu = new InfoCpu();
         * infocpu.imprimirInfoCPU();
         * 
         * //Informacion de memoria
         * 
         * InfoMem infomem = new InfoMem(); infomem.imprimirInfo();
         */
        /*
         ...
         * fichero.write("seg     |       "); fichero.write(max +
         * "       |       "); fichero.write(min + "       |       ");
         * fichero.write(avg + "       |       ");
         * 
         * fichero.close();
